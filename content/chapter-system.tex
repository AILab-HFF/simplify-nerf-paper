...
Requests from the client are sent to the service using HTTP, and, in the case of an asynchronous operation, the server updates the client using WebSockets \fref{sec:system:architecture}.
