...
\cleanchapterquote{Also in der Planungsphase kam [NeRF] glaube ich ziemlich gut an, Setbegehung, Planung vorne vom eigentlichen Dreh, aber die Qualität war halt noch nicht so überzeugend.}{Participant 4}{}
...
\cleanchapterquote{Probleme? Optimisierung, also Datensätze.
Beim Training würde ich sagen, eine gro{\ss}e Sache ist die Optimierung und die Parameterisierung, vor allem in Nerfstudio.}{Participant 1}{}
...
\cleanchapterquote{Das Wichtigste wäre für mich, dass ich halt nichts in der Konsole machen muss.
Also, dass ich einfach das Programm starte und dann alles in der UI machen kann, hochladen und dann auch irgendwie durchgeführt werde.}{Participant 2}{}
...
% Such interfaces support collaborative efforts, allowing users to easily share and review project stages. \cite{P1, P3}
...
\cleanchapterquote{Also wenn eine Fehlermeldung ist, dann wäre es halt cool, wenn die einem das irgendwie genauer sagen würden, was der Fehler ist, und dann nicht einfach so irgendein Log.}{Participant 2}{}
...
\cleanchapterquote{Es muss halt verständlich genug sein, dass Filmstudenten davon keine Angst haben. Aber trotzdem, [das Ma{\ss}] wie sehr du deine Parameter ansetzen kannst [nicht] zu limitieren.}{Participant 1}{}
