...
The renders are listed below the viewer, and once they finished processing, they can be downloaded to the user's machine \frefadd{fig:design:viewer-section}{2}.
